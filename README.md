...
- [Click](https://github.com/grapefruit0205/click) - Lifecycle-hook guardrail for Codex that enforces one approved execution boundary and blocks repeated replanning, rescanning, and over-verification.
